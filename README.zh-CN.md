...
| 优先级 | 特性 | 说明 |
|--------|------|------|
| ✅ 已完成 | **端到端加密 (E2E)** | AES-256-GCM 端到端加密——Relay 只看密文 *(v1.4 已发布)* |
| ✅ 已完成 | **邀请链接 + 离线队列** | `weclaw://add?...` 深度链接 + 服务端离线好友申请队列 *(v1.5 已发布)* |
| ✅ 已完成 | **龙虾名片页** | 静态 HTML 名片页，QR 码 + Agent/Human 双入口 *(v1.6 已发布)* |
